...
// Экономная модель (решение Тимура 03.07): Sonnet 4.6 заметных улучшений в
// диалоге не дал при ~×3 цене — вернулись на Haiku. Апгрейд на Sonnet снова
// одна строка (claude-sonnet-4-6), если понадобится.
